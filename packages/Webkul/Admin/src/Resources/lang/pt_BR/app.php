...
return [
    ...
    'users' => [
        ...
        'users' => [
            ...
            'confirm-delete-title' => 'Confirme a senha antes de excluir',
            'delete-last' => 'Ao menos um admin é obrigatório.',
            'delete-success' => 'Sucesso! Usuário Excluído',
    ...
    'settings' => [
        ...
        'sliders' => [
            ...
            'update-fail' => 'Slider não pode ser atualizado',
        ...
        'tax-categories' => [
            ...
            'code' => 'Código',
            'description' => 'Descrição',
            'select-taxrates' => 'Selecione as Taxas de Impostos',
            'edit' => [
    ...
    'promotions' => [
        'cart-rules' => [
            ...
            'buy-x-get-y-free' => 'Compre o X Pegue Y grátis',
    ...
    'cms' => [
        'pages' => [
            ...
            'helper-classes' => 'Classes Auxiliadoras'
        ]
    ],
    ...
    'response' => [
        ...
        'delete-category-root' => 'Não é possível excluir a categoria raíz',
    ...
    'admin' => [
        'emails' => [
            ...
            'notifications' => [
                'verification' => 'Enviar e-mail de verificação',
                'registration' => 'Enviar registro e-mail',
                'customer' => 'Enviar e-mail do cliente',
                'new-order' => 'Enviar e-mail de confirmação de pedido',
                'new-admin' => 'Enviar e-mail de convite de administrador',
                'new-invoice' => 'Enviar e-mail de confirmação da fatura',
                'new-refund' => 'Enviar e-mail de notificação de reembolso',
                'new-shipment' => 'Enviar e-mail de notificação de remessa',
                'new-inventory-source' => 'Enviar e-mail de notificação de origem de inventário',
        ...
        'system' => [
            ...
            'email-sender-name' => 'Nome do E-mail da Loja',
            'shop-email-from'   => 'Endereço de E-mail da Loja [Para enviar e-mails]',
